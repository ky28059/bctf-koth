...
export default function AnimatedToast(props: ToastProps) {
    ...
    return (
        ...
        >
            <div className={'group relative bg-white dark:bg-zinc-950 rounded-sm shadow-xl px-4 py-3 border-l-4 ' + (props.toast.success ? 'border-lime-500' : 'border-red-500')}>
                ...
                <ToastPrimitive.Close aria-label="Close" className="absolute -top-1.5 -left-3 bg-white dark:bg-black rounded-full size-5 text-primary flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-75">
                    ×
